...
import com.example.myapplication.databinding.SmallWeatherWidgetConfigureBinding;
...
/**
 * The configuration screen for the {@link smallWeatherWidget smallWeatherWidget} AppWidget.
 */
public class smallWeatherWidgetConfigureActivity extends Activity {

    private static final String PREFS_NAME = "com.example.myapplication.smallWeatherWidget";
    private static final String PREF_PREFIX_KEY = "appwidget_";
    int mAppWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID;
    private final Context context = smallWeatherWidgetConfigureActivity.this;
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            Intent intent = new Intent(context, smallWeatherWidget.class);
            intent.setAction("com.example.myapplication.UPDATE_WIDGET");
            intent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, mAppWidgetId);
            intent.putExtra("SELECTED_KEY_small", selectedKey);
    ...
    private SmallWeatherWidgetConfigureBinding binding;

    public smallWeatherWidgetConfigureActivity() {
        super();
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.small_weather_widget_configure);
